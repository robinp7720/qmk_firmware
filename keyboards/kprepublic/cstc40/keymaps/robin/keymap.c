...
#define LAYOUT_ortho_4x12 LAYOUT_planck_mit
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_DVORAK] = LAYOUT_ortho_4x12(
			...
			KC_LCTL, UG_TOGG, KC_LALT, KC_LGUI, LOWER, KC_SPC,  RAISE,   FUNCTION, KC_RALT, KC_PSCR, KC_RCTL \
			),
	...
	[_FUNCTION] = LAYOUT_ortho_4x12( \
			...
			CG_LSWP, KC_LEFT, KC_DOWN, KC_RGHT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_PGUP, _______, \
	...
	[_ADJUST] =  LAYOUT_ortho_4x12( \
			XXXXXXX, QK_BOOT,    DB_TOGG,  RGB_TOG,  RGB_MOD, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  KC_DEL, \
			XXXXXXX, UC(0xe4), UC(0xf6), XXXXXXX, UC(0xfc), XXXXXXX, NK_TOGG, QWERTY,  XXXXXXX, DVORAK,  UC(0xdf), XXXXXXX, \
			XXXXXXX, UG_TOGG,  UG_NEXT,  UG_PREV,  UG_SPDU, UG_SPDD, UG_VALU, UG_VALD, XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX, \
			_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______ \
			),
